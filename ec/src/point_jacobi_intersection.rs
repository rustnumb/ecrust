...
ref_field_impl! {
    impl<F> JacobiIntersectionPoint<F> {
        ...
        pub fn add(&self, other: &Self, curve: &JacobiIntersectionCurve<F>) -> Self {
            ...
            let s3_num = &(&other.c * &(&self.s * &other.d)) + &(&self.d * &(&other.s * &self.c));
            let c3_num = &(&other.c * &self.c) - &(&(&self.d * &other.s) * &(&self.s * &other.d));
            let d3_num = &(&self.d * &other.d) - &(&(&curve.a * &self.s) * &(&self.c * &(&other.s * &other.c)));
